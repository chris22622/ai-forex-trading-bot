...
from config import DERIV_DEMO_API_TOKEN, DERIV_LIVE_API_TOKEN, DERIV_WS_URL
...
class DerivAPIFixer:
    ...
    def generate_fix_recommendations(self, results: Dict[str, Dict[str, Any]]) -> None:
        ...
        if working_tokens:
            ...
            print("2. Update config.py to use the working token")

            if len(working_tokens) > 1:
                print("3. You have multiple working tokens - choose based on your needs:")
                print("   - DEMO: For testing and practice")
                print("   - LIVE: For real trading with real money")
    ...
    async def create_fixed_config(self, results: Dict[str, Dict[str, Any]]) -> None:
        ...
        if self.working_token and self.working_mode:
            ...
            print("✅ Fixed configuration saved to config_fixed.py")
