...
async def test_real_trading():
    ...
    try:
        ...
        print("⚠️  Make sure you're ready for this test!")
        print("⚠️  The trade will appear in your MT5 terminal!")
        ...
        if trade_result and trade_result.get('success'):
            ...
            print("📱 The trade should appear in your MT5 terminal immediately")
            print("📈 Look in the 'Trade' tab and 'Terminal' window")
...
if __name__ == "__main__":
    ...
    if result:
        ...
        print("🔧 Check MT5 connection and permissions")
