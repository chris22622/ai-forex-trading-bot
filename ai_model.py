...
class TradingAI:
    ...
    def extract_features(self, indicator_data: Dict[str, Any]) -> Dict[str, float]:
        ...
        try:
            ...
            features['breakout'] = 1.0 if patterns.get('breakout_up') or patterns.get('breakout_down') else 0.0
    ...
    def advanced_ml_predict(self, features: Dict[str, float], price_history: List[float]) -> Tuple[str, float]:
        ...
        try:
            ...
            adjusted_confidence = abs(combined_score) * (1 - vol_factor * 0.3)  # Reduce confidence in high volatility
    ...
    def generate_prediction_reason(self, features: Dict[str, float], prediction: str, confidence: float) -> str:
        ...
        try:
            ...
            if accuracy < 0.4 and self.performance_metrics['total_predictions'] > 20:
                ...
                for feature in self.feature_weights:
                    ...
                    self.feature_weights[feature] = max(0.05, min(0.4,
                        self.feature_weights[feature] + change))
    ...
    def get_performance_report(self) -> Dict[str, Any]:
        ...
        if len(self.prediction_history) >= 10:
            ...
            report['recent_activity'] = {
                ...
                'avg_confidence': np.mean([p['confidence'] for p in recent_buy_sell]) if recent_buy_sell else 0.0
            }
...
def optimize_confidence_threshold(prediction_history: List[Dict[str, Any]], results: List[str]) -> float:
