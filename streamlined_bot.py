...
def place_trade(action: str) -> bool:
    ...
    try:
        ...
        if result.retcode != mt5.TRADE_RETCODE_DONE:
            ...
            failure_msg = f"❌ <b>TRADE FAILED</b>\\n"
...
async def main():
    ...
    startup_msg += f"━━━━━━━━━━━━━━━━━━━\\n"
    startup_msg += f"📊 <b>Account Details:</b>\\n"
    ...
    startup_msg += f"🧠 AI Mode: <b>Enhanced Multi-Signal</b>\\n"
    startup_msg += f"� Trading: <b>BUY & SELL</b>\\n"
            ...
            if current_price > 0:
                ...
                if len(price_history) >= 5:
                    ...
                    if (prediction['prediction'] in ['BUY', 'SELL'] and 
                        ...
                        print(f"📊 Waiting for higher confidence signal...")
