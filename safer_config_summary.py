...
print(f"   • Per Trade: +$0.75 profit target")
print(f"   • Daily Goal: +$2.25 (3 successful trades)")
print(f"   • Weekly Goal: +$11.25")
print(f"   • Monthly Goal: +$45 (doubling your account!)")
print(f"   • Growth Rate: ~5% per week (sustainable)")
